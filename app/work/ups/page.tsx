...
export const metadata = {
  title: "UPS Location Model — Thinh Ngo",
  description:
...
export default function Page() {
  return (
    <CaseStudy
      ...
      tagline="Where should a parcel network put its next drop boxes? A model that turns public census and facility data into a ranked expansion lead list &mdash; across 29,943 ZIP codes."
      facts={[
      ...
      blocks={[
        ...
        },
        {
          ...
          body: (
            <p>
              I led the initial UPS research and shaped the analytical flow, then guided data collection, variable selection, and the exploratory analysis, with hands-on coding support. I had a say in model selection &mdash; and I owned the part that makes a model matter: translating the outcomes into plain business language, the ethics analysis, and the implications for where and why UPS should expand.
            </p>
          ),
        },
        {

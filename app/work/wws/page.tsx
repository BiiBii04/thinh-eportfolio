      ...
      blocks={[
        {
          ...
          body: (
            <p>
              We started trying to cover &ldquo;all major disabilities&rdquo; — unshippable, and mentors said so. We narrowed to two groups, neurodivergent and visually impaired users, and rebuilt the flows around them. My first versions run too broad; this is where I learned to cut early.
            </p>
          ),
        },
        {

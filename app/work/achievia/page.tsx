    ...
    <CaseStudy
      ...
      blocks={[
        ...
        },
        {
          ...
          body: (
            <p>
              No live demo to link, because a teammate locked the repo post-event. The proof is the deck, the write-up, and the Top 20 result. Next time I&rsquo;d treat the hackathon as networking, not just competition.
            </p>
          ),
        },
      ]}
